...
public class Picker implements CallBackTask{
    private Context context;
    private final PickerCallbacks pickiTCallbacks;
    ...
    public Picker(Context context, PickerCallbacks listener){
        ...
        String returnedPath;
            ...
            // Local file was selected
                ...
                if (returnedPath == null || returnedPath.equals("")){
                    ...
                    pickiTCallbacks.onCompleteListener(returnedPath, false, false, false, Utils.errorReason());
                }
                // Path is not null
                else {
                    // This can be caused by two situations
    ...
    @Override
    public void onPostExecute(String path, boolean wasDriveFile, boolean wasSuccessful, String reason) {
    ...
    public void deleteTemporaryFile(){
        ...
        if (folder != null) {
            if (deleteDirectory(folder)){
                Log.i("Picker "," deleteDirectory was called");
            }
        }
    }
