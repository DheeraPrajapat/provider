...
public class NewHomeFragmentVM extends BaseFragmentViewModel {
    ...
    final SingleRequestEvent<List<MapListModel>> suggestionsEvent = new SingleRequestEvent<>();
    ...
    public void getCities(int id,String input){
        welcomeRepo.getCities(sharedPref.getUserData().getAuthKey(),id, input).subscribeOn(Schedulers.io())
