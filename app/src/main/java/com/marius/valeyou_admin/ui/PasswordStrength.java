...
public enum PasswordStrength {
    WEAK(R.string.weak, Color.parseColor("#FFFF4455")),
    MEDIUM(R.string.medium, Color.parseColor("#a6a6a6")),
    STRONG(R.string.strong, Color.parseColor("#0D9211")),
    VERY_STRONG(R.string.very_strong, Color.parseColor("#0D9211"));
